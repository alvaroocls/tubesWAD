...
{{-- <x-layout>
    <x-slot:content>
        <div class="container mt-5">
            ...
            <div class="mb-4">
                <a href="{{ route('musician.profile.create') }}" class="btn btn-primary">Create New Profile</a>
            </div>
                    ...
                    <tbody>
                        @if ($musician)
                            <tr>
                                ...
                                <td>{{ $musician->email }}</td>
                                <td>
                                    <span class="badge bg-primary">{{ ucfirst($musician->role) }}</span>
                                </td>
                                <td>
                                    <a href="{{ route('musician.profile.edit', $musician->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="{{ route('musician.profile.show', $musician->id) }}" class="btn btn-info btn-sm">Show</a> <!-- Show button -->
                                </td>
                            </tr>
                        @else
                            <tr>
                                <td colspan="7" class="text-center">No profile found for this user.</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
